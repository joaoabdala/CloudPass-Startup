...
void deletarCliente()
{
    ...
    linhaGrande();
    printf(GREEN"\nId\t Usuário  \t E-mail  \t\t\t Telefone"RESET);
    linhaGrande();
    ...
    while (fgets(qntdUsuarios, 255, colaboradorBD) != NULL)
    {
        ...
        //verificando se o usuario é supervisor
    ...
    // critica não exista colaboradores
    if (i == 0)
    {
        system("cls");
        colaboradorLogo();
        printf(RED "\n[!]" RESET " - Não existe clientes cadastrado no sistema!");
    ...
    //verificando se o digito é válido

    if (opDelColab != 1)
    {
        printf(RED"\nDigite um ID válido!"RESET);
        getch();
        clientes();
    }
    ...
    {
        printf(RED"\nCliente não identificado"RESET);
        fclose(colaboradorBD);
    ...
    //percorrendo todos os colaboradores até o
...
void exibirColaboradores()
{
    ...
    while (fgets(qntdUsuarios, 255, clientesBD) != NULL)
    {
        ...
        //verificando se o usuario é usuario
    ...
    if (i == 0)
    {
        system("cls");
        colaboradorLogo();
        printf(RED "\n[!]" RESET " - Não existe colaboradores cadastrado no sistema!");
        fclose(clientesBD);
        getch();
        colaboradores();
    }
...
void deletarColaborador()
{
    ...
    if (contadorUsuarios == 0)
    {
        printf(RED"\nColaborador não identificado"RESET);
        fclose(colaboradorBD);
        fclose(colaboradorBDTemp);
...
void menuLojaS()
{
    ...
    while (opcao <1 || opcao > 4)
    {
        ...
        printf(YELLOW "[3] " RESET "- Deletar um jogo específico\n");
        printf(YELLOW "[4] " RESET "- Voltar");
